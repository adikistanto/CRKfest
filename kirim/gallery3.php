	...
	<body style="margin:0px" id="top">
		...
		<div id="content"><!--tambahan-->
			...
			<div id="wrapper">
				...
				<div  class="sector">
					<div id="sector_label" class=""><h2>Awarding</h2></div>
					<div id="content_page" class="">
						<!-- The link foto -->
							<a href="assets/images/gallery/awarding/Awarding(1).jpg" data-lightbox="roadtrip"><img class="galery_thumb" src="assets/images/gallery/awarding/Awarding(1).jpg" /></a>
							<a href="assets/images/gallery/awarding/Awarding(2).jpg" data-lightbox="roadtrip"><img class="galery_thumb" src="assets/images/gallery/awarding/Awarding(2).jpg" /></a>
							<a href="assets/images/gallery/awarding/Awarding(3).jpg" data-lightbox="roadtrip"><img class="galery_thumb" src="assets/images/gallery/awarding/Awarding(3).jpg" /></a>
						<!--end galery-->
					</div>
				</div>
