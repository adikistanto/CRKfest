		...
		<div id="content"><!--tambahan-->
			<div id="left_side">
				<center>
					...
					<div id="sub_menu" >
						<a href="brief.php"><div class="sub_menu_label">Brief</div></a>
			...
			<div id="wrapper">
				...
				<div id="tentang_caraka" class="sector">
					...
					<div id="content_page">
						<img style="width:100%" src="assets/images/competition/titlebrief.png">
						<div class="brief_field">
							<a href="sm.php"><img class="brief_item"src="assets/images/competition/briefsm.png"/></a>
							<a href="hki.php"><img class="brief_item"src="assets/images/competition/briefhki.png"/></a>
							<a href="datsun.php"><img class="brief_item"src="assets/images/competition/datsun.png"/><a/>
							<img class="brief_item"src="assets/images/competition/briefwillbe.png"/>
						</div>
					</div>
