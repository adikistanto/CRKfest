	...
	<body style="margin:0px" id="top">
		...
		<div id="content"><!--tambahan-->
			...
			<div id="wrapper">
				...
				<div  class="sector">
					<div id="sector_label" class=""><h2>Judging</h2></div>
					<div id="content_page" class="">
						<!-- The link foto -->
							<a href="assets/images/gallery/judging/judging(1).jpg" data-lightbox="roadtrip"><img class="galery_thumb" src="assets/images/gallery/judging/judging(1).jpg" /></a>
							<a href="assets/images/gallery/judging/judging(2).jpg" data-lightbox="roadtrip"><img class="galery_thumb" src="assets/images/gallery/judging/judging(2).jpg" /></a>
							<a href="assets/images/gallery/judging/judging(3).jpg" data-lightbox="roadtrip"><img class="galery_thumb" src="assets/images/gallery/judging/judging(3).jpg" /></a>
