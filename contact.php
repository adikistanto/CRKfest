		...
		<div id="content"><!--tambahan-->
			<div id="left_side">
				<center>
					...
					<div id="page_label">Contact</div>
				</center>
			</div>
			<div id="wrapper">
				<img id="watermark" src="assets/images/watermark.png" />
				<div id="tentang_caraka" class="sector">
					<div id="sector_label" class=""><h2>Contact</h2></div>
					<div style="clear:both;width:100%"><hr></div>
					<div id="content_page" class="">
						<p><b>Apapun yang ingin kamu share dengan kami, kami siap untuk mendengarkan.<br><br>

						Email :<br>

						panitia@carakafest.org<br>
						panitia [at] carakafest [dot] org<br><br><br>


						Our Mailing Address <br>
						Jl.Trilomba Juang No.10<br>
						Sekretariat PPPI Pengda Jateng<br>
						Semarang, Jawa Tengah 50243<br>
						Indonesia<br></b></p><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
