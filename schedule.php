		...
		<div id="content"><!--tambahan-->
			<div id="left_side">
				<center>
					...
					<div id="page_label">Schedule</div>
					<div id="sub_menu" >
						<a href="schedule.php"><div class="sub_menu_label">Our Schedule</div></a>
						<a href="roadshow.php"><div class="sub_menu_label">Roadshow</div></a>
					</div>
				</center>
			</div>
			<div id="wrapper">
				...
				<div id="tentang_caraka" class="sector">
					<div id="sector_label" class=""><h2>Schedule</h2></div>
					<div id="content_page" class="">
						<div class="schedule_tile"><p><h5>Roadshow</h5><br>27 Oktober - 6 November</p></div>
						<div class="schedule_tile"><p><h5>Call for Entry</h5><br> 27 Oktober - 13 November</p></div>
						<div class="schedule_tile"><p><h5>Gallery</h5><br>11-13 Desember</p></div>
						<div class="schedule_tile"><p><h5>Seminar</h5><br>11 Desember</p></div>
						<div class="schedule_tile"><p><h5>Portfolio Night</h5><br>12 Desember</p></div>
						<div class="schedule_tile"><p><h5>Camp Finalis</h5><br>12-13 Desember</p></div>
						<div class="schedule_tile"><p><h5>Workshop</h5><br>13 Desember</p></div>
					</div>
				</div>
				<div id="mask_small" class="black_bg"></div>
				<div id="footer">
					<br><br><br><p id="copyright">Copyright&nbsp&copy; Carakafest2014</p>
